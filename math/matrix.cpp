...
stdex::math::matrix<_Tp>::matrix(int x_dimension,int y_dimension) : x_dimension_(x_dimension) , y_dimension_(y_dimension) {
	...
	for (int i=0;i<x_dimension;i++) {
		...
		for (int j=0;j<y_dimension;j++) {
			m_[i][j]=std::math::base_unit_trait<_Tp>::zero();
		}
	}
}

template <typename _Tp>
stdex::math::matrix<_Tp>::matrix(int x_dimension,int y_dimension,std::initializer_list<_Tp> init_list) : x_dimension_(x_dimension) , y_dimension_(y_dimension) {
...
stdex::math::matrix<_Tp> stdex::math::matrix<_Tp>::power(int times) const {
	...
	if (times<0) throw std::invalid_argument("Times must be positive");
...
template <typename _Tp>
stdex::math::matrix<_Tp> stdex::math::matrix<_Tp>::expansion(int x,int y) const {
...
template <typename _Tp>
stdex::math::matrix<_Tp> stdex::math::matrix<_Tp>::expand_to(int to_x,int to_y,int x_dimension,int y_dimension) const {
	if (x_dimension<x_dimension_ || y_dimension<y_dimension_ || (x_dimension==x_dimension_ && y_dimension==y_dimension_)) throw std::invalid_argument("Traget dimensions are too small");
...
template <typename _Tp>
stdex::math::matrix<_Tp> stdex::math::matrix<_Tp>::expand_to(int x_dimension,int y_dimension) const {
	return expand_to(0,0,x_dimension,y_dimension);
}

template <typename _Tp>
stdex::math::matrix<_Tp> stdex::math::matrix<_Tp>::crop_to(int from_x,int from_y,int x_dimension,int y_dimension) const {
	if (x_dimension>x_dimension_ || y_dimension>y_dimension_ || (x_dimension==x_dimension_ && y_dimension==y_dimension_)) throw std::invalid_argument("Traget dimensions are too large");
...
template <typename _Tp>
stdex::math::matrix<_Tp> stdex::math::matrix<_Tp>::crop_to(int x_dimension,int y_dimension) const {
